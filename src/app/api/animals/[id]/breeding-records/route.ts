  ...
  try {
    ...
    const inseminationEvents = history.events
      ...
      .map((e: any) => ({
        ...
        bull_name_or_semen_source: e.bull_name_or_semen_source,
        semen_type: e.semen_type,
    ...
    const calvingEvents = history.events
      ...
      .map((e: any) => ({
        ...
        calving_actual_date: e.calving_actual_date,
        calving_actual_time: e.calving_actual_time,
        calf_alive: e.calf_alive,
        assistance_required: e.assistance_required,
        complications: e.complications,
        colostrum_quality: e.colostrum_quality,
        colostrum_produced: e.colostrum_produced,
        veterinarian_name: e.veterinarian_name,
        calf_tag_number: e.calf_tag_number,
        calf_weight: e.calf_weight,
        calf_gender: e.calf_gender,
        calf_birth_date: e.calf_birth_date,
        calf_breed: e.calf_breed,
        calf_health_status: e.calf_health_status,
        calf_sire_tag: e.calf_sire_tag,
        calf_sire_name: e.calf_sire_name,
        calf_weaning_date: e.calf_weaning_date,
        calf_weaning_weight: e.calf_weaning_weight,
        calf_notes: e.calf_notes,
        created_at: e.created_at
      }))
    ...
    const pregnancyCheckEventsFromEvents = history.events
      ...
      .map((e: any) => {
        ...
        return {
          ...
          veterinarian_name: e.veterinarian_name,
          estimated_due_date: e.estimated_due_date,
          steaming_date: e.steaming_date ?? pregnancyRecord?.steaming_date ?? null,
          gestation_length_days: e.gestation_length_days ?? pregnancyRecord?.gestation_length_days ?? null,
          result: resultValue,
    ...
    const pregnancyChecksFromRecords = history.pregnancyRecords.map((p: any) => {
      ...
      return {
        ...
        steaming_date: p.steaming_date || null,
        gestation_length_days: p.gestation_length_days || null,
        result: resultValue,
