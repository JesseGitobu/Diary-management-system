...
export async function importAnimalsActionWithAuth(
  ...
  try {
    ...
    // This prevents server timeout while ensuring client sees immediate success.
    ...
    void (async () => {
      try {
        ...
        // Note: Cannot call revalidatePath here - background tasks run after response sent
        // Client will refresh data on next page load or via manual refetch
      } catch (error) {
