...
export function FeedStatsCards({ stats, averageDaysRemaining, alertCounts }: FeedStatsCardsProps) {
  ...
  const scroll = (direction: 'left' | 'right') => {
    ...
    const scrollAmount = isMobile ? 192 : 280 // Width of card + gap (mobile: w-40+gap, desktop: w-64+gap)
    const newScrollLeft =
      direction === 'left'
  ...
  const isStatusWarning = alertCounts.low > 0 || (averageDaysRemaining > 7 && averageDaysRemaining <= 14)
  const isStatusCritical = alertCounts.critical > 0 || averageDaysRemaining <= 7
    ...
    return (
      <div className="w-full space-y-4">
        ...
        <div className="flex items-center justify-between px-4 sm:px-0">
          <h2 className="font-semibold text-gray-900 text-base">Feed Overview</h2>
            ...
            {stats.map((stat) => {
              ...
              return (
                <Card
                  key={stat.title}
                  className={cn(
                    "flex-shrink-0 w-56 shadow-sm transition-all duration-200",
                      ...
                      <div className="flex items-center gap-1">
                        {stat.isGood ? (
                          ...
                          <>
                            ...
                            <span className="text-xs font-medium text-yellow-600">{stat.trend}</span>
                          </>
                        )}
                      </div>
                    )}
              ...
              <div className="flex items-center gap-1.5">
                {isStatusGood ? (
                  ...
                  <>
                    ...
                    <span className="text-xs font-semibold text-yellow-700">Monitor</span>
                  </>
                ) : (
                  <>
            ...
            <div className="flex items-center gap-2">
              {isStatusGood ? (
                ...
                <>
                  ...
                  <span className="text-sm font-semibold text-yellow-700">Monitor</span>
                </>
              ) : (
                <>
